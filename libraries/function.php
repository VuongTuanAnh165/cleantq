...
function base_url()
{
    return $url = "http://cleantq.com/";
}
function base_img($link)
{
    return $url = "http://cleantq.com/pages_img/" . $link . "/";
}
...
function base_url_be()
{
    return $url = "http://cleantq.com/admin/";
}
function modules($url)
{
    return base_url_be() . "admin/modules/" . $url;
}

if (!function_exists('redirectAdmin')) {
    function redirectAdmin($url = "")
    {
        header("location: " . base_url_be() . "pages/{$url}");
        exit();
    }
}

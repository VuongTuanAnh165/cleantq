                            ...
                            <div class="col-sm-8">
                                <label className='cursor-pointer select-wrapper'>
                                    <div className='logo-wrapper'>
                                        <img width="100px" id="anh1" src="<?php echo base_img('post_type') . $post_type['post_type_img'] ?>" alt="your image">
                                    </div>
                                    <input id="exampleFormControlFile1" type="file" style="display: none;" onchange="preview_thumbail1(this);" name='post_type_img' />
                                </label>
                            </div>
                        </div>

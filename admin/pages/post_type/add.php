...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $target = "../../../pages_img/post_type/" . basename($post_type_img);
    $data =
        [
    ...
    $data_img =
        [
            ...
            "pages_img_link" => base_img("post_type").$post_type_img
        ];
                ...
                <div class="col-12">
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Tên tiêu đề" name='post_type_title'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class='form-control-file' id="exampleFormControlFile1" name='post_type_img' onchange="preview_thumbail(this);">

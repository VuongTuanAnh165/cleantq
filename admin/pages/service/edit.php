...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if ($_FILES['service_image']['name'] != '') {
        ...
        $target = "../../../pages_img/service/" . basename($service_image);
        $data =
            [
        ...
        $data_img =
            [
                ...
                "pages_img_link" => base_img("service") . $service_image
            ];
                            ...
                            <div class="col-sm-8">
                                <label className='cursor-pointer select-wrapper'>
                                    <div className='logo-wrapper'>
                                        <img width="100px" id="anh1" src="<?php echo base_img('service') . $service['service_image'] ?>" alt="<?php echo $service['service_image'] ?>">
                                    </div>
                                    <input id="exampleFormControlFile1" type="file" style="display: none;" onchange="preview_thumbail1(this);" name='service_image' />
                                </label>
                            </div>
                        </div>

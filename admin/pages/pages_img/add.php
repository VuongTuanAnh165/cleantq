...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $target = "../../../pages_img/" . $pages_img_gr["pages_img_gr_name"] ."/". basename($pages_img_name);
    $data =
        [
            "pages_img_gr_id" => postInput('pages_img_gr_id'),
            "pages_img_name" => postInput('new_file') . "." . postInput('new_end'),
            "pages_img_link" => base_img($pages_img_gr["pages_img_gr_name"]).postInput('new_file') . "." . postInput('new_end')
        ];
    if (in_array($file_ext, $expensions) === false) {
        ...
        if ($file_size > 2097152) {
            ...
            if (postInput('new_file') == '') {
                ...
                if (file_exists("../../../pages_img/" . $pages_img_gr["pages_img_gr_name"] . "/" . postInput('new_file') . "." . postInput('new_end'))) {
                    echo "<script>alert('Tên file đã tồn tại, vui lòng đổi tên');</script>";
                } else {
                    $id_insert = $db->insert("pages_img", $data);
                    if ($id_insert > 0 && move_uploaded_file($_FILES['pages_img_name']['tmp_name'], $target) && rename($target, "../../../pages_img/" . $pages_img_gr["pages_img_gr_name"] . "/" . postInput('new_file') . "." . postInput('new_end'))) {
                ...
                <div class="col-12">
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class='form-control-file' id="exampleFormControlFile1" name='pages_img_name' onchange="preview_thumbail(this);">

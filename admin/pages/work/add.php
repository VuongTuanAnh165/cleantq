    ...
    if (postInput('work_name') == '') {
        ...
        if (in_array($file_ext, $expensions) === false) {
            ...
            if ($file_size > 2097152) {
                ...
                $id_insert = $db->insert("work", $data);
                $id_insert_img = $db->insert("pages_img", $data_img);
                if ($id_insert > 0 && $id_insert_img > 0 && move_uploaded_file($_FILES['work_img']['tmp_name'], $target)) {
                ...
                <div class="col-12">
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Tên hoạt động" name='work_name'>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class='form-control-file' id="exampleFormControlFile1" name='work_img' onchange="preview_thumbail(this);">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Mô tả" name='work_description'>
                            </div>
                        </div>
